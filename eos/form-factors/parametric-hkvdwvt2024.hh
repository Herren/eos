...
#ifndef EOS_GUARD_EOS_FORM_FACTORS_PARAMETRIC_HKVDWVT2024_HH
#define EOS_GUARD_EOS_FORM_FACTORS_PARAMETRIC_HKVDWVT2024_HH 1
...
namespace eos
{
    /* Form Factors according to [HKVDWVT:2024A] */
    template <typename Process_, typename Transition_> class HKVDWVT2024FormFactors;

    template <typename Process_, typename Transition_> class HKVDWVT2024FormFactorTraits;


    // P -> PP
    template <typename Process_>
    class HKVDWVT2024FormFactorTraits<Process_, PToPP2> :
        public virtual ParameterUser
    {
        public:
            ...
            UsedParameter q2p_a, q2p_v, q20, sin, s0;
            ...
            HKVDWVT2024FormFactorTraits(const Parameters & p) :
                m_P1(UsedParameter(p[std::string(Process_::name_P1) + "@HKVDWVT2024"], *this)),
                m_P2(UsedParameter(p[std::string(Process_::name_P2) + "@HKVDWVT2024"], *this)),
                m_P3(UsedParameter(p[std::string(Process_::name_P3) + "@HKVDWVT2024"], *this)),
                ...
                q2p_a(UsedParameter(p[std::string(Process_::label) + "::tp_a@HKVDWVT2024"], *this)),
                q2p_v(UsedParameter(p[std::string(Process_::label) + "::tp_v@HKVDWVT2024"], *this)),
                q20(UsedParameter(p[std::string(Process_::label) + "::t0@HKVDWVT2024"], *this)),
                sin(UsedParameter(p[std::string(Process_::label) + "::sin@HKVDWVT2024"], *this)),
                s0(UsedParameter(p[std::string(Process_::label) + "::s0@HKVDWVT2024"], *this))
            {
            }
    ...
    template <typename Process_> class HKVDWVT2024FormFactors<Process_, PToPP2> :
        public FormFactors<PToPP2>
    {
        private:
            ...
            const HKVDWVT2024FormFactorTraits<Process_, PToPP2> _traits;
        ...
        public:
            HKVDWVT2024FormFactors(const Parameters & p, const Options &);

            ~HKVDWVT2024FormFactors();

            static FormFactors<PToPP2> * make(const Parameters & parameters, const Options & options);
    ...
    extern template class HKVDWVT2024FormFactors<BToPiPi, PToPP2>;
