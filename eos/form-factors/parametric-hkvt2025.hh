...
namespace eos
{
    ...
    class HKVT2025FormFactorTraits<Process_, PToPP2> :
    ...
    template <typename Process_> class HKVT2025FormFactors<Process_, PToPP2> :
        public FormFactors<PToPP2>
    {
        private:
            ...
            const HKVT2025FormFactorTraits<Process_, PToPP2> _traits;
    ...
    extern template class HKVT2025FormFactors<BToPiPi, PToPP2>;
