...
namespace eos
{
    ...
    HKVT2025FormFactorTraits<Process_, PToPP2>::resonance_0m_names
    {
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string>
    HKVT2025FormFactorTraits<Process_, PToPP2>::resonance_1m_names
    {
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::up), "mass::B_u^*@BSZ2015" },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::down), "mass::B_d^*@BSZ2015" },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), "mass::B_s^*@BSZ2015" },
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string>
    HKVT2025FormFactorTraits<Process_, PToPP2>::resonance_1p_names
    {
    ...
    template<typename Process_>
    HKVT2025FormFactors<Process_, PToPP2>::HKVT2025FormFactors(const Parameters & p, const Options &) :
        _traits(HKVT2025FormFactorTraits<Process_, PToPP2>(p)),
        _mP1(_traits.m_P1),
        _mP2(_traits.m_P2),
        _mP3(_traits.m_P3),
    ...
    template<typename Process_>
    HKVT2025FormFactors<Process_, PToPP2>::~HKVT2025FormFactors() = default;

    template<typename Process_>
    FormFactors<PToPP2> *
    HKVT2025FormFactors<Process_, PToPP2>::make(const Parameters & parameters, const Options & options)
    {
    ...
    template<typename Process_>
    QualifiedName
    HKVT2025FormFactors<Process_, PToPP2>::_par_name(const std::string & ff_name, unsigned wave, unsigned idx) const
    {
    ...
    template<typename Process_>
    double
    HKVT2025FormFactors<Process_, PToPP2>::_phi(const int & l, const double & s, const double & q2, const double & q2p, const double & chi,
    ...
    template<typename Process_>
    inline double
    HKVT2025FormFactors<Process_, PToPP2>::_phi_g(const double & q2, const double & s, const unsigned & l) const
    {
        if (l > 0)
        {
    ...
    template<typename Process_>
    inline double
    HKVT2025FormFactors<Process_, PToPP2>::_phi_f(const double & q2, const double & s, const unsigned & l) const
    {
        if (l > 0)
        {
    ...
    template<typename Process_>
    inline double
    HKVT2025FormFactors<Process_, PToPP2>::_phi_F1(const double & q2, const double & s, const unsigned & l) const
    {
        if (l > 0)
        {
    ...
    template<typename Process_>
    inline double
    HKVT2025FormFactors<Process_, PToPP2>::_phi_F2(const double & q2, const double & s, const unsigned & l) const
    {
        if (l > 0)
        {
    ...
    template <typename Process_>
    complex<double>
    HKVT2025FormFactors<Process_, PToPP2>::v_perp(const double & q2, const double & s, const unsigned & l, const bool & iso) const
    {
    ...
    template <typename Process_>
    complex<double>
    HKVT2025FormFactors<Process_, PToPP2>::a_par(const double & q2, const double & s, const unsigned & l, const bool & iso) const
    {
        const double isospin_factor = (iso) ? std::sqrt(Process_::eta_2[l]) : std::sqrt(Process_::eta_1[l]);
        if ( isospin_factor == 0.0 )
                return 0.0;
    ...
    template <typename Process_>
    complex<double>
    HKVT2025FormFactors<Process_, PToPP2>::a_0(const double & q2, const double & s, const unsigned & l, const bool & iso) const
    {
        const double isospin_factor = (iso) ? std::sqrt(Process_::eta_2[l]) : std::sqrt(Process_::eta_1[l]);
        if ( isospin_factor == 0.0 )
                return 0.0;
    ...
    template <typename Process_>
    complex<double>
    HKVT2025FormFactors<Process_, PToPP2>::a_t(const double & q2, const double & s, const unsigned & l, const bool & iso) const
    {
        const double isospin_factor = (iso) ? std::sqrt(Process_::eta_2[l]) : std::sqrt(Process_::eta_1[l]);
        if ( isospin_factor == 0.0 )
                return 0.0;
    ...
    template <typename Process_>
    double
    HKVT2025FormFactors<Process_, PToPP2>::unitarity_integrand_0m(const double & s, const unsigned & l, const bool & iso) const 
    {
        double res = 0.0;
    ...
    template <typename Process_>
    double
    HKVT2025FormFactors<Process_, PToPP2>::unitarity_integrand_1p(const double & s, const unsigned & l, const bool & iso) const 
    {
        double res_f = 0.0;
        double res_F1 = 0.0;
    ...
    template <typename Process_>
    double
    HKVT2025FormFactors<Process_, PToPP2>::unitarity_integrand_1m(const double & s, const unsigned & l, const bool & iso) const 
    {
        double res = 0.0;
    ...
    template <typename Process_>
    Diagnostics
    HKVT2025FormFactors<Process_, PToPP2>::diagnostics() const
    {
        Diagnostics results;
    ...
    template<typename Process_>
    const std::set<ReferenceName> HKVT2025FormFactors<Process_, PToPP2>::references
    {
        "HKVT:2025A"_rn
    };

    template<typename Process_>
    const std::vector<OptionSpecification> HKVT2025FormFactors<Process_, PToPP2>::options
    {
    };

    template<typename Process_>
    std::vector<OptionSpecification>::const_iterator
    HKVT2025FormFactors<Process_, PToPP2>::begin_options()
    {
    ...
    template<typename Process_>
    std::vector<OptionSpecification>::const_iterator
    HKVT2025FormFactors<Process_, PToPP2>::end_options()
    {
        return options.cend();
    }
}
