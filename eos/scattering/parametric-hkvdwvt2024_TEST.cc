...
class HKVDWVT2024ScatteringAmplitudesTest :
    public TestCase
{
    public:
        HKVDWVT2024ScatteringAmplitudesTest() :
            TestCase("pi_pi_to_pi_pi_hkvdwvt2024_scattering_amplitudes_test")
        {
        }
        ...
        virtual void run() const
        {
            ...
            /* Factory */
            {
                ...
                std::shared_ptr<ScatteringAmplitudes<PPToPP>> amp = ScatteringAmplitudeFactory<PPToPP>::create("pipi->pipi::HKVdWvT2024", p, Options{ });
...

            {
                ...
                HKVDWVT2024ScatteringAmplitudes amp(p, Options{ });
                ...
                TEST_CHECK_NEARLY_EQUAL( amp.omnes_factor(0.700332 , 0 , IsospinRepresentation::zero).real()   ,  0.4543722 ,  eps);
                TEST_CHECK_NEARLY_EQUAL( amp.omnes_factor(0.700332 , 0 , IsospinRepresentation::zero).imag()   ,  1.3383008 ,  eps);
                TEST_CHECK_NEARLY_EQUAL( amp.omnes_factor(25.0     , 0 , IsospinRepresentation::zero).real()   , -0.0036454 ,  eps);
                TEST_CHECK_NEARLY_EQUAL( amp.omnes_factor(25.0     , 0 , IsospinRepresentation::zero).imag()   ,  0.0000417 ,  eps);
                ...
                std::cerr << amp.omnes_factor(0.55  , 1 , IsospinRepresentation::one) << " " << amp.omnes_factor(0.8  , 1 , IsospinRepresentation::one) << " " << amp.omnes_factor(1.2  , 1 , IsospinRepresentation::one) << std::endl;
            }
        }
} pi_pi_to_pi_pi_hkvdwvt2024_scattering_amplitudes_test;
