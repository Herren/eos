...
#ifndef EOS_GUARD_EOS_SCATTERING_PARAMETRIC_HKVDWVT2024_HH
#define EOS_GUARD_EOS_SCATTERING_PARAMETRIC_HKVDWVT2024_HH 1
...
namespace eos
{
    ...
    class HKVDWVT2024ScatteringAmplitudes :
        public ScatteringAmplitudes<PPToPP>
    {
        ...
        public:
            HKVDWVT2024ScatteringAmplitudes(const Parameters & p, const Options &);

            ~HKVDWVT2024ScatteringAmplitudes();
